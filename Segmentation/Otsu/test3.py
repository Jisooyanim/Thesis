#https://github.com/BhanuPrakashNani/Image_Processing/blob/master/OTSU%20Thresholding/thresholding.py

import cv2 
import numpy as np

img = cv2.imread('dataset with preprocess/preprocessed/Powdery Mildew/20211109_121404 (Custom).jpg', cv2.IMREAD_GRAYSCALE)  
cv2.imshow('gray', img)
