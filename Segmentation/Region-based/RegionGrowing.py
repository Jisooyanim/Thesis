...
class regionGrow():
    ...
    def ApplyRegionGrow(self, input_folder, output_folder, cv_display=True):
        for filename in os.listdir(input_folder):
            if filename.endswith(('.png', '.jpg', '.jpeg')):
                ...
                print(f"Iterations for {filename}: {str(self.iterations)}")
...
# Example usage
input_folder_path = "dataset with preprocess/preprocessed/Sooty Mould"
output_folder_path = "dataset with preprocess/Segmented/region growing/sooty mould"

#10 or 11
exemple = regionGrow(10)
exemple.ApplyRegionGrow(input_folder_path, output_folder_path)
