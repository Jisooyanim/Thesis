...
IMG_PATH = os.path.join(os.getcwd(),"dataset with preprocess/preprocessed/Cutting Weevil") # path for input image directory
OUTPUT_PATH = os.path.join(os.getcwd(),"dataset with preprocess/Segmented/fuzzy c means/Cutting Weevil") # path for output directory
...
def get_args():
    ...
    #-----------------Algorithm-----------------
    parser.add_argument('-a', '--algorithm', default='EnFCM', choices=['FCM', 'EnFCM', 'MFCM'], type=str,
    ...
    #-----------------User parameters-----------------
    parser.add_argument('--plot_show', default=0, choices=[0,1],
